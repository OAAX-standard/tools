 ...
 * 
 * @note the tensors parameters is assumed to be a valid pointer allocated using malloc.
 */
 ...
 * @return true if the two tensors_structs have the exact same bytes, false otherwise.
 */
